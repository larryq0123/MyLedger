...
public class EmulatorDetector {
    ...
    /**
     * 特殊的模擬器特徵文件
     * 186項文件，查到一個文件就是百分百模擬器，權重最高
     *
     * 模擬器核心GoldFish
     * /data下的特徵文件需要許可權才可以訪問，其他目錄下的特徵文件不需要
     * 因為模擬器的話，都是root許可權，所以並不需要擔心許可權問題。
     *  轉載請註明出處：CSDN 胖虎
    ...
    public static final String[] emulatorFiles = {
            ...
            //這兩個會出現在samsung s9+跟asus zenpad
//            "/ueventd.goldfish.rc",
//            "/init.goldfish.rc",

            // ========針對原生Android模擬器 核心：goldfish===========
